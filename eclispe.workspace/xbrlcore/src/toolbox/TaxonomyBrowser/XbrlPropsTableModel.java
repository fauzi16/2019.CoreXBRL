...
*/
public abstract class XbrlPropsTableModel extends AbstractTableModel {
  /**
   * 
   */
  private static final long serialVersionUID = 5664807540442063385L;
	
  Browser ParentClass = null;
  /**
  ...
  */
  ...
  /**
    Default constructor
  */
  public XbrlPropsTableModel(){
    super();
  }

  /**
    Reads the XBRL nodes into the table model class and reports changes in the table.
    @param currentNode XBRL document to be entered in the table
  */
  public void setTable(XbrlTbUserObject currentNode){
    ...
    List<String> lKeyList = new ArrayList<String>(lAttributes.keySet());
