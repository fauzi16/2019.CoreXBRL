...
public class MultipleDimensionType implements Serializable, Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        newMDT.setPresentDimensionDomain((SingleDimensionType) presentDimensionDomain.clone());
        newMDT.setPredecessorDimensionDomainSet((Set<SingleDimensionType>) ((HashSet<SingleDimensionType>) predecessorDimensionDomainSet).clone());
        return newMDT;
    }
    ...
    public SingleDimensionType getSingleDimensionType(Concept dimensionElement) {
        ...
        for (SingleDimensionType currSDT : predecessorDimensionDomainSet) {
    ...
    public boolean equalsDimensionalStructure(Object obj) {
        ...
        for (Map.Entry<Concept, Concept> currEntry : thisDimensionDomainMap.entrySet()) {
    ...
    public boolean equals(Object obj) {
        ...
        for (SingleDimensionType currSingleDimensionType : thisSingleDimensionTypeList) {
    ...
    public List<Concept> getAllDimensions() {
        ...
        for (SingleDimensionType sdt : predecessorDimensionDomainSet) {
    ...
    public Map<Concept, Concept> getPredecessorDimensionDomainMap() {
        ...
        for (SingleDimensionType currentSDT : predecessorDimensionDomainSet) {
