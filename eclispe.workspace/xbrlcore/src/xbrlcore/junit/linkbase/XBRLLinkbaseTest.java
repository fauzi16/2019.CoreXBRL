...
public final class XBRLLinkbaseTest {
    ...
    public void getXLinkElementByLabel() {
        ...
        ExtendedLinkElement xLinkElementProdukte = xLinkElementProdukteList.get(0);
        ...
        ExtendedLinkElement xLinkElementProdukte2 = xLinkElementProdukte2List.get(0);
        ...
        ExtendedLinkElement xLinkElementEssen = xLinkElementEssenList.get(0);
    ...
    public void getTargetXLinkElements() {
        ...
        ExtendedLinkElement xLinkElementWurst = xLinkElementListEssen.get(0);
    ...
    public void getSourceXLinkElements() {
        ...
        ExtendedLinkElement xLinkElementEssen = xLinkElementList.get(0);
        assertNotNull(xLinkElementEssen);
        assertEquals("Essen", xLinkElementEssen.getLabel());
        assertEquals("p-pr_Essen", ((Locator) xLinkElementEssen).getConcept()
            .getID());
    ...
    public void buildSourceNetwork() {
        ...
        while (sourceNetworkIterator.hasNext()) {
            Concept currCon = ((Locator) sourceNetworkIterator.next()).getConcept();
    ...
    public void getArcForSourceLocator() {
        Concept elementEssen = prTaxonomy.getConceptByID("p-pr_Essen");
        Locator loc = prTaxonomy.getDefinitionLinkbase()
            .getExtendedLinkElementFromBaseSet(elementEssen, null);
        ...
        Locator loc2 = prTaxonomy.getDefinitionLinkbase()
            .getExtendedLinkElementFromBaseSet(elementEssen,
                "http://www.xbrl.org/2003/role/link2");
