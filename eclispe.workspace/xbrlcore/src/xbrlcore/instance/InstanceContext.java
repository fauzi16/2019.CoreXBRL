...
public class InstanceContext implements Serializable {
    ...
    private List<Element> scenarioElements; // List of elements within the scenario element (besides dimensional information)

    private List<Element> segmentElements; // List of elements within the segment element (besides dimensional information

    private MultipleDimensionType mdtScenario; // represents the dimensions and domains this context refers to in the <scenario> element

    private MultipleDimensionType mdtSegment; // represents the dimensions and domains this context refers to in the <segment> element
