...
public class LabelLinkbase extends Linkbase {
    ...
    public static final String DEFAULT_ARC_ROLE = "http://www.xbrl.org/2003/arcrole/concept-label";
		...
		if (languageSet == null) {
			...
			for (ExtendedLinkElement currExLinkElement : getExtendedLinkElements()) {
				if (currExLinkElement.isResource()) {
                    Resource currResource = (currExLinkElement instanceof Locator) ? ((Locator)currExLinkElement).getResource() : (Resource) currExLinkElement;
